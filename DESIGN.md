...
- **Accent:** the app itself is near-monochrome and uses system colours. The app icon (`scripts/make-icon.swift`, `make icon`) carries the website's cobalt blueprint tile: a white line-drawn phone on a stand over a drafting grid.
